    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/beomjo/tt/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/beomjo/tt.git")
                    developerConnection.set("scm:git:ssh://github.com/beomjo/tt.git")
                    url.set("https://github.com/beomjo/tt/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/beomjo/tt/issues")
                }
            }
        }
    }
